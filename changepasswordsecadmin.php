            ...
            <div class="row">
                ...
                <div class="col-md-9">
                                ...
                                <div class="form-row align-items-center">
                                    <div class="col-auto my-1">
                                        <select name="filter" class="custom-select mr-sm-2" required id="filter" onchange="this.form.submit()">
                                            ...
                                            <option value="2" selected>Security Administrator</option>
                    ...
                    <div class="page-wrapper">
                        ...
                        <form action="validateoldpassword.php" method="POST">
                            <label for="email">Enter Email: </label>
                            <input type="text" id="email" name="email">
                            <input type="text" style="visibility: hidden" id="role" name="role" value="2">
                            <br>
